...
export const InputGroup = React.forwardRef(function InputGroup(props, ref) {
    ...
    return (_jsxs(Group, { ref: ref, ...rest, children: [startElement && (_jsx(InputElement, { pointerEvents: "none", ...startElementProps, children: startElement })), React.cloneElement(children, {
                ...(startElement && {
